...
您也可以下載範例來編輯及追蹤特定的里程碑任務 [此處](/help/marketo-tutorial-implementing-new-instance/assets/adobe-marketo-engage-implementation-milestones-project-management-template.xlsx).
...
<table>
 ...
 <tbody>
    ...
    <tr>
        <td><em>範例 — </em> 設定網域金鑰識別郵件(DKIM)和2個單獨的CNAME，用於傳遞能力與電子郵件追蹤連結。</td>
        <td bgcolor="c6f0cf">完成</td>
        <td>9/15/24</td>
        <td>9/18/24</td>
        <td>IT團隊提供的支援與設定</td>
    ...
    <tr>
        ...
        <td><em>範例 — </em> 建立Marketo Engage使用者與角色</td>
        <td bgcolor="c6f0cf">完成</td>
        <td>8/27/24</td>
        <td>9/15/24</td>
    ...
    <tr>
        <td><em>範例 — </em> 訓練4名使用者，並為他們提供標準Marketo使用者存取權</td>
        <td bgcolor="ffc7cf">未開始</td>
        <td>12/13/24</td>
        <td>不適用</td>
    ...
    <tr>
        <td rowspan="2">入門</td>
        <td><em>範例 — </em> 傳送第一份Newsletter</td>
        <td bgcolor="ffc7cf">未開始</td>
        <td>12/9/24</td>
        <td>不適用</td>
