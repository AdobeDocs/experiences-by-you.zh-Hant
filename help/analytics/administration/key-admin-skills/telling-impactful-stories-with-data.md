...
從定義目前狀況並建立問題或機會開始。 您正在搭建舞台並提供足夠的資訊來吸引受眾，但並未完全揭露解決方案。 這個介紹很重要（也可能具有挑戰性），但它是您分析的全部動機！  資料storytelling的值是提示導致&#x200B;**變更行為**&#x200B;的動作。 否則，資料、Insight和分析將無用武之地。
...
Levelwing [!DNL Analytics]主管Amy Ard
