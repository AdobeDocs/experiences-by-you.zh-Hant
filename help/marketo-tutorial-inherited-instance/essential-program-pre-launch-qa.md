...
| 3 | **程式命名慣例** | 這組是否正確遵循您的命名慣例？ 連結至您的命名慣例工具或試算表（若有）。 | 公式： [方案型別] - [日期] [類別]： [簡短描述] | **是：** <br>如果您無法以「是」回答此問題或無法確定，請檢閱您的命名慣例，並視需要更新程式名稱。 | [組織新 [!DNL Marketo Engage] 執行個體的最佳實務](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/fundamentals/best-practices-to-organize-a-new-instance.html?lang=zh-Hant){target="_blank"} |
...
| 4 | **Meta/OG標籤** | 是否已設定OG標籤？ 標題、說明、影像等。 這會影響頁面在社交分享中的顯示方式。 | **是：** <br>如果您無法以「是」來回答，則應更新所有標籤。 | [編輯登陸頁面標題和中繼資料](https://experienceleague.adobe.com/docs/marketo/using/product-docs/demand-generation/landing-pages/landing-page-actions/edit-landing-page-title-and-metadata.html?lang=zh-Hant){target="_blank"} |
