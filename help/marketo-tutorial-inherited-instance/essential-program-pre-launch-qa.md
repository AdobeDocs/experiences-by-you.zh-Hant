...
|---|---|---|---|---|---|
| 1 | **程式型別** | 合適嗎？ | 如果是參與計畫，其是否符合邏輯？ 若為預設值，其是否合乎邏輯？ | **是：** <br>如果您無法以「是」回答這個問題，您可能需要變更您的程式型別。 | [瞭解程式](https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/programs/creating-programs/understanding-programs.html?lang=zh-Hant){target="_blank"} |
| 2 | **頻道** | 此管道合適嗎？ 管道步驟/計畫狀態是否支援計畫的成功管理？ | 如果設定為電子報，這是否合理，以及計畫狀態是否支援計畫的目的，或您是否嘗試扭曲已存在但不適用的內容？ | **是：** <br>如果您無法以「是」回答這個問題，您必須變更頻道，或與[!DNL Marketo Engage]系統管理員討論建立新頻道 | [建立方案頻道](https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/tags/create-a-program-channel.html?lang=zh-Hant){target="_blank"}<br><br> [瞭解頻道](https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/programs/working-with-programs/understanding-tags.html?lang=zh-Hant#channel){target="_blank"} |
| 3 | **程式命名慣例** | 這組是否正確遵循您的命名慣例？ 連結至您的命名慣例工具或試算表（若有）。 | 公式： [方案型別] - [日期] [類別]： [簡短描述] | **是：** <br>如果您無法以「是」回答此問題或無法確定，請檢閱您的命名慣例，並視需要更新程式名稱。 | [組織新 [!DNL Marketo Engage] 執行個體](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/fundamentals/best-practices-to-organize-a-new-instance.html?lang=zh-Hant){target="_blank"}的最佳實務 |
| 4 | **期間成本** | 您是否已指派期間成本標籤給程式？ | 如果您花費1000美元製作一部在7月推出的電子書，則該計畫在7月的期間成本為1000美元。 | **是：** <br>如果您無法以「是」回答這個問題，請新增期間成本，即使它只有零！ | [在方案中使用期間成本](https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/programs/working-with-programs/using-period-costs-in-a-program.html?lang=zh-Hant){target="_blank"} |
| 5 | **成功** | 您確定計畫的目標和成功量度了嗎？ 您知道要如何測量此計畫嗎？ 您是否已用計畫狀態變更標籤它？ | 如果這是「聊天」頻道，則狀態進度可以是「成員」、「參與」和「已轉換」。 | **是：** <br>如果您無法以「是」回答此問題，就無法輕易瞭解您的行銷活動是否造成任何影響。 識別您的主要目標是什麼，然後是一種衡量它的方法 — 即使它是在7天後手動匯入清單。 | [程式狀態](https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/programs/creating-programs/understanding-program-membership.html?lang=zh-Hant#program-statuses){target="_blank"} |
| 6 | **客群** | 您是否已識別計畫的對象？ |  | **是：** <br>如果您無法以「是」回答這個問題，請在計畫傳送之前先檢視。 |  |
| 7 | **代號** | 您是否已更新所有必要的計畫代號？ | 如果是網路研討會程式，您是否已更新活動日期、活動標題、說明和行事曆檔案等？ | **是或不適用** <br>如果您無法以「是」回答或不知道它是否適用，請檢查您的程式「Token」索引標籤。 檢視程式是否包含必須更新的任何本機權杖 | [瞭解程式中的我的Token](https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/programs/tokens/understanding-my-tokens-in-a-program.html?lang=zh-Hant){target="_blank"} |
...
| 6 | **Google [!DNL Analytics]整合** | 您的Web Personalization是否已與Google [!DNL Analytics]整合？ | **是或否：**<br>&#x200B;如果回答否，請瞭解您追蹤哪些網頁個人化影響的能力有限。 | 在Google中[個人化的再行銷](https://experienceleague.adobe.com/docs/marketo/using/product-docs/web-personalization/website-retargeting/personalized-remarketing-in-google.html?lang=zh-Hant){target="_blank"} |
| 7 | **網頁區段** | <li>所選區段合適嗎，是否適用於正確的網域？ <li>區段是否正傳送至Google [!DNL Analytics]？ | **是：** <br>如果您無法以「是」來回答，則必須更新它。 | [網頁區段](https://experienceleague.adobe.com/docs/marketo/using/product-docs/web-personalization/using-web-segments/web-segments.html?lang=zh-Hant){target="_blank"}<br><br>[尋找使用特定區段的網頁 [!DNL Campaign]](https://experienceleague.adobe.com/docs/marketo/using/product-docs/web-personalization/using-web-segments/find-web-campaigns-that-are-using-a-specific-segment.html?lang=zh-Hant){target="_blank"} |

>[!TAB 登錄頁面]

| # | 評論區域 | 要問的問題 | 接受條件 | 其他資源 |
|---|---|---|---|---|
| 1 | **設計** | 設計是否與品牌一致？ 其是否使用適當的範本？ | **是：** <br>如果您無法以「是」回答這個問題，您要麼需要很好的理由，要麼必須重新設計。 | [編輯Marketo登陸頁面範本](https://experienceleague.adobe.com/docs/marketo/using/product-docs/demand-generation/landing-pages/landing-page-templates/edit-a-marketo-landing-page-template.html?lang=zh-Hant){target="_blank"} |
| 2 | **正在測試** | 是否已針對各種裝置和瀏覽器進行測試？ 它是否能呈現整潔且運作正常？ | **是：** <br>如果您無法以「是」來回答，您應該跨裝置和瀏覽器測試預覽連結。 | [預覽登陸頁面](https://experienceleague.adobe.com/docs/marketo/using/product-docs/demand-generation/landing-pages/landing-page-actions/preview-a-landing-page.html?lang=zh-Hant){target="_blank"} |
| 3 | **URL** | 是否已自訂頁面URL？ 是否符合邏輯/是否遵循命名慣例？ | **是：** <br>如果您無法以「是」來回答，則應更新頁面URL。 | [變更登陸頁面URL](https://experienceleague.adobe.com/docs/marketo/using/product-docs/demand-generation/landing-pages/landing-page-actions/change-the-landing-page-url.html?lang=zh-Hant){target="_blank"} |
| 4 | **Meta/OG標籤** | 是否已設定OG標籤？ 標題、說明、影像等。 這會影響頁面在社交分享中的顯示方式。 | **是：** <br>如果您無法以「是」來回答，則應更新所有標籤。 | [編輯登入頁面標題和中繼資料](https://experienceleague.adobe.com/docs/marketo/using/product-docs/demand-generation/landing-pages/landing-page-actions/edit-landing-page-title-and-metadata.html?lang=zh-Hant){target="_blank"} |
...
| 7 | **影像** | 使用的所有影像是否已正確壓縮？ 如果有任何影像上覆蓋有文字，是否清楚易讀？ 您有權使用這些影像嗎？它們是否在品牌上？ | **是/不適用：** <br>所有影像（如果有的話）都應該壓縮以提升電子郵件載入速度。 | [取代已上傳的影像或檔案](https://experienceleague.adobe.com/docs/marketo/using/product-docs/demand-generation/images-and-files/replace-an-uploaded-image-or-file.html?lang=zh-Hant){target="_blank"} |
...
| # | 評論區域 | 要問的問題 | 接受條件 | 其他資源 |
|---|---|---|---|---|
| 1 | **準確度** | 是否已檢查、檢閱所有必要的智慧型[!DNL Campaign]，並視為正確？ | **是：** <br>如果您無法以「是」來回答，請先修正並檢查這些專案，然後再繼續。 | [智慧 [!DNL Campaign] 檢查清單](https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/smart-campaign-checklist.html?lang=zh-Hant){target="_blank"} |
| 2 | **傳送計數** | 如果您的電子郵件傳送行銷活動是批次行銷活動（未觸發），請檢視「排程」索引標籤中的潛在客戶計數 — 數字是否與您期望的一致？ 其是否低於中止臨界值？ | **是：** <br>如果您無法以「是」來回答，請先修正並檢查這些專案，然後再繼續。 | [排程您的電子郵件程式](https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/email-programs/email-program-actions/schedule-your-email-program.html?lang=zh-Hant){target="_blank"} |
...
| 5 | **參與度計劃** | 在參與計畫中使用智慧[!DNL Campaign]時，是否有步驟確保成員已適當地新增、暫停和重新啟動？ 這些步驟是否已由其他人檢閱？ | **是或不適用：**<br>&#x200B;如果這是參與計畫，而且您無正當理由無法以是回應，請等到此專案就緒後再啟用。 | [新增人員至參與計畫](https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/drip-nurturing/creating-an-engagement-program/add-people-to-an-engagement-program.html?lang=zh-Hant){target="_blank"} |
| 6 | **訂閱喜好設定** | 是否已包含所有必要的訂閱偏好設定因素？ | **是或不適用：**<br>&#x200B;如果您不確定，請詢問您的[!DNL Marketo Engage]系統管理員。 您需要一個好的理由才能繼續進行N/A （例如，作業傳送）。 | [如何設定及管理訂閱中心](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/lead-and-data-management/subscription-center-watch.html?lang=zh-Hant){target="_blank"} |
| 7 | **程式狀態** | 更新計畫狀態是否包含流程步驟？ | **是：** <br>如果您無法以「是」來回答，您應該將這些專案新增至您的「智慧型[!DNL Campaign]」流程步驟中。 | [變更方案狀態](https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/smart-campaigns/program-flow-actions/change-program-status.html?lang=zh-Hant){target="_blank"} |
...
| 9 | **評分影響** | 是否已考量潛在客戶/個人評分的任何影響？ | **是或不適用：** <br>如果您無法回答是或不適用，請詢問您的系統管理員。 | [簡單評分](https://experienceleague.adobe.com/docs/marketo/using/getting-started-with-marketo/quick-wins/simple-scoring.html?lang=zh-Hant){target="_blank"}<br><br>[如何建立潛在客戶評分方案](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/lead-and-data-management/lead-scoring-watch.html?lang=zh-Hant){target="_blank"} |
| 10 | **收入週期Modeler (RCM)影響** | 是否考慮對人員生命週期模型有任何影響？ | **是或不適用：**&#x200B;如果您無法回答[是]或[成本]，請詢問您的系統管理員。 | [收入週期Modeler設定](https://experienceleague.adobe.com/docs/marketo/using/product-docs/demand-generation/facebook/set-up-facebook-offline-conversions.html?lang=zh-Hant){target="_blank"} |
| 11 | **對參與計畫的影響** | <li>您是否考慮過影響現有的參與計畫？ <li>您是否確定人員不會受到多重通訊的轟炸？ | **是或不適用：**<br>&#x200B;如果您無法回答是或不適用，請詢問您的系統管理員。 | [避免傳送重複的內容](https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/drip-nurturing/using-engagement-programs/avoid-sending-duplicate-content.html?lang=zh-Hant){target="_blank"} <br><br>[套用通訊限制到Smart [!DNL Campaign]](https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/apply-communication-limits-to-smart-campaign.html?lang=zh-Hant){target="_blank"} |
| 12 | **報告成功** | 是否以邏輯方式衡量方案成功與否？ 成功合理嗎 — 在過程中不會太接近？ 不會太遠而難以達成嗎？ 您有如何報告和衡量成功以內部溝通的策略嗎？ | **是：** <br>如果您無法回答是，請重新思考您的成功量度定義。 | [變更方案成功](https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/smart-campaigns/program-flow-actions/change-program-success.html?lang=zh-Hant){target="_blank"} |
...
| 9 | **文字版本最佳化** | <li>文字版本的版面配置是否已最佳化？<li>是否顯示任何HTML註解？<li>是否包含所有相關內容？ | **是：**<br>&#x200B;自動產生的文字版本可能很難閱讀 — 值得最佳化。 | [編輯電子郵件的文字版本](https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/general/creating-an-email/edit-the-text-version-of-an-email.html?lang=zh-Hant){target="_blank"} |
...
| 11 | **HTML/主要版本** | <li>您是否已建立電子郵件的HTML/主要版本？<li>您是否已傳送測試給您自己？ | **是（除非只有純文字）：**<br>&#x200B;如果您無法以「是」來回答，請先傳送測試給您自己再繼續。 | [編輯電子郵件的HTML](https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/general/functions-in-the-editor/edit-an-emails-html.html?lang=zh-Hant){target="_blank"} |
...
| 15 | **動態內容** | <li>您的電子郵件中是否有動態內容？<li>您是否曾在多個案例中測試過？ | **是：**<br>&#x200B;如果您無法以「是」回答這個問題，請先測試後再繼續。 | [在電子郵件中使用動態內容](https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/general/functions-in-the-editor/using-dynamic-content-in-an-email.html?lang=zh-Hant){target="_blank"}<br><br>[預覽包含動態內容的電子郵件](https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/general/functions-in-the-editor/preview-an-email-with-dynamic-content.html?lang=zh-Hant){target="_blank"} |
...
| 18 | **作業傳送** | <ul><li>您是否將電子郵件設定為可運作（表示它會略過取消訂閱設定）？<li>若是如此，您對此有合理理由嗎？</li> | **是或否：**<br>&#x200B;如果回答是，您應該有有效的理由以操作電子郵件傳送。 如果您不確定，請詢問您的[!DNL Marketo Engage]管理員。 | [讓電子郵件運作](https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/general/functions-in-the-editor/make-an-email-operational.html?lang=zh-Hant){target="_blank"} |
