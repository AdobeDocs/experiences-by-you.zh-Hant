...
+ [!DNL Analytics]由您{#analytics}
   ...
   + [!DNL Analytics]簡介{#intro-to-analytics}
      + 正在從其他平台轉換{#transitioning-from-other-platforms}
         + [正在從 [!DNL Google Analytics]轉換](../analytics/intro-to-analytics/transitioning-from-other-platforms/transition-from-google-analytics.md)
   ...
   + 管理 {#administration}
      + 關鍵管理員技能{#key-admin-skills}
         ...
         + [以非技術方式翻譯 [!DNL Adobe Analytics] 技術語言](../analytics/administration/key-admin-skills/translating-adobe-analytics-technical-language.md)
...
+ [!DNL Campaign]由您{#campaign}
   ...
   + 策略與思維領導{#strategy}
      + [行銷人員 [!DNL Adobe Campaign] 成功的十大最佳實務](/help/campaign/10-best-practices-for-marketers.md)
+ 由您Experience Manager{#experience-manager}
   ...
   + AEM as a Cloud Service {#cloud-service}
      ...
      + 最佳實務{#cloud-manager-best-practices}
         ...
         + [規劃移轉至AEM as a Cloud Service](/help/experience-manager/cloud-service/expert-resources/aem-champions/migration.md)
         + [Post移轉策略和提示](/help/experience-manager/cloud-service/expert-resources/aem-champions/post-migration.md)
         + [使用Best Practice Analyzer](/help/experience-manager/cloud-service/expert-resources/aem-champions/best-practice-analyzer.md)
         + [解決移轉至AEM as a Cloud Service時的挑戰](/help/experience-manager/cloud-service/expert-resources/aem-champions/migration-challenges.md)
